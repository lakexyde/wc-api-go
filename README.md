...
```
go get github.com/ducnt114/wc-api-go
```
...
```
go get -u github.com/ducnt114/wc-api-go
```
...
```go
import "github.com/ducnt114/wc-api-go/client"
...
import (
	"fmt"
	"github.com/ducnt114/wc-api-go/client"
